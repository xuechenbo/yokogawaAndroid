...
public class TeRuleListUtils {
        ...
        for (int k = 0; k < list.size(); k++) {
            ...
            for (int i = 0; i < check.size(); i++) {
                ...
                for (int j = 0; j < children.size(); j++) {
                    ...
                    if ("多选一".equals(checkType) || checkType.isEmpty() || modeRuleNumber.isEmpty()) {
                        //普通规则多选一    7    7-1,2
                        newchildren.add(children1);
                    } else if ("是否显示".equals(checkType)) {
                        if (isShowVi(checkType, children1.getRemark(), children1.getModeRuleNumber(), refresBean, modeName)) {
                            newchildren.add(children1);
                        }
                        ...
                        if (ExamUtils.isHasComma(modeRuleNumber)) {
                            ...
                            String[] splitRemark = children1.getRemark().split("&");//备注
                            if (isShowVi(checkType, ruleStr[0], splitRemark[0], refresBean, modeName)) {
                            ...
                            if (isShowVi(checkType, ruleStr[0], remarkStr[0], refresBean, modeName)) {
    ...
    //TODO 是否显示
    public static boolean isShowVi(String checkType, String remark, String modeRuleNumber, RefresBean refresBean, String modeName) {
        if ("0".equals(modeRuleNumber)) {
            ...
            return false;
        } else if (modeRuleNumber.contains("|") || remark.contains("|")) {
        ...
        } else if ("0".equals(ExamUtils.getArrayAddStr(modeRuleNumber)[0])) {
            //TODO 包含指图书的规则   0+9
    ...
    public static NewExamBean.Project.Check.Children isShowCon(NewExamBean.Project.Check.Children children1, String modeName, RefresBean refresBean, String ruleMap, String checkName) {
        ...
        if ("0".equals(newModeRule)) {
        ...
        } else if (newCheckType.equals("显示型名")) {
            //最多两个
        ...
        } else if (newCheckType.equals("数据比较A")) {
            ...
            if (remark.contains("/")) {
                ...
                children1.setRemark(JsonUtils.getRuleContentStr(modeName, children1.getModeHead(), children1.getModeRuleNumber()));
                children1.setShowValue(JsonUtils.getRuleContentStr(modeName, children1.getModeHead(), children1.getModeRuleNumber()));
            }
